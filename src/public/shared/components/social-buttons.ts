...
export class SocialButtons extends $LitElement() {
	render() {
		return html`
			<schmancy-flex gap="md" justify="center" class="mt-4">
				<a
					href="https://chat.whatsapp.com/LsIWyP8U9mRJZKkBqGTOS7"
					target="_blank"
					rel="noopener noreferrer"
					class="inline-flex items-center gap-3 px-6 py-3 rounded-full bg-[#25D366] hover:bg-[#128C7E] text-white text-base font-semibold transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-105 font-body"
				>
