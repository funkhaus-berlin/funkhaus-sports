...
import { BookingFlowType } from './booking-flow.types'
import { Address as BaseAddress } from './booking.types'

// Extend the base Address interface to include coordinates for venues
